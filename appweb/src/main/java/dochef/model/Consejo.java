...
public class Consejo implements Serializable{
    ...
    @Id
    @GeneratedValue
    @Column(name="id_consejo", nullable = false, length= 10)
	public int getId() {
		return id;
	}
	...
	@Column(name="ingredientes", nullable=false, length=500)
	public void setIngredientes(String ingredientes) {
		this.ingredientes = ingredientes;
	}
	
	
	@Column(name="preparacion", nullable=false, length=2000)
	...
	public String toString() {
		return "Consejo [id=" + id + ", titulo=" + titulo
