<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
		...
		<div class="row posts">
			<div class="col-md-12">
				...
				<c:forEach items="${recetas}" var="receta" varStatus="status">
			
				<div class="row post">
					<div class="col-lg-12">
						<div class="post-title">
							<a href="<c:url value="/public/recetas/${receta.id}"/>">${receta.titulo}</a>
						</div>
					</div>
					<div class="col-lg-2">
						<img src="<c:url value='/resources/img/posts/${receta.imagen}' />" class="full-width">
					</div>
					<div class="col-lg-7">
						<p>
